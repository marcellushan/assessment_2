...
// More headers
$headers .= 'From: <webmaster@highlands.edu>' . "\r\n";
...
<h2>Issue:</h2>
<h3>" . $email_text . "</h3>
<a href='http://" .$servername . "/site/misc/assessment_2/Submitted.php?id=" . $assessment_id ."'>Click Here to go to Assessment</a>
</body>
</html>
";
...
<h2>Issue:</h2>
<h3>" . $email_text . "</h3>
<a href='http://" .$servername . "/site/misc/assessment_2/Saved.php?id=" . $assessment_id . "&team_name=" . htmlspecialchars($team_name) . "&team_type=" . $team_type . "&team_id=" . $team_id .  "'>Click Here to go to Assessment</a>
</body>
</html>
";
