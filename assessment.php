...
<p></p>
 ...
 <div class="well">
 <form name="myForm" action="assessment_saved.php" onsubmit="return check()" method="post">
...
<? } 
	    ...
	    var t = document.forms["myForm"]["course"].value;
    if (t == null || t == "") {
        alert("Course Being Assessed must be filled out");
        return false;
    }
...
<?  }  ?>
    ...
    if (x == null || x == "") {
        alert("Performance Target must be filled out");
        return false;
    }
