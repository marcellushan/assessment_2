...
if($team_type==1) 
	...
	{
		$sql = "UPDATE assessment SET goals_id='$goal_id',  user_id='$user_id', outcome_assessment='$outcome_assessment', performance_targets= '$performance_targets' WHERE assessment_id = '$assessment_id'";
	}
