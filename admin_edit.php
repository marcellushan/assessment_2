...
//use the team_type session variable to determine the SQL string
 ...
 $sql ="select * from assessment, goals, users, team where assessment.assessment_id= '$assessment_id' AND goals.goals_id=assessment.goals_id AND assessment.user_id=users.user_id AND goals.goals_id=assessment.goals_id  AND assessment.team_id=team.team_id";
...
<br>
<br>
<form  action="sysadmin_saved.php?id=<? echo $assessment_id ?>&team_type=1" method="post">
