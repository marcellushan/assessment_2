...
<tr><td><b>Summary of Data Collected <br />(Performance Results)</b></td><td><textarea name="data_summary" rows="10" cols="75"><? if ((@$_GET['admin'] == "1") || ($assessment_check >= "1")) { echo str_replace("<br />","",$data_summary); } ?></textarea></td></tr>
<tr><td><b>Recommended Actions</b></td><td><textarea name="recommended_actions" rows="10" cols="75"><? if ((@$_GET['admin'] == "1") || ($assessment_check >= "1")) { echo str_replace("<br />","",$recommended_actions); } else { ?>1) Change(s) that will be made to teaching or assessment to improve results and close the loop on this outcome
