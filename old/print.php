...
$getuser = mysql_query("SELECT users_id FROM users WHERE users_username='$username' AND unit_team_id='$assessment_id';", $conn3);
...
$getassessment = mysql_query("SELECT * FROM assessment,goals WHERE goals.goals_id=assessment.goals_id AND unit_team_id='$assessment_id' AND assessment_period='$year';", $conn3);
...
<tr><td width="200"><b>Unit/Team</b></td><td><? echo $unit_team_a; ?></td></tr>
<tr><td><b>Reported By</b></td><td><? echo $users_name_a; ?></td></tr>
...
<tr><td style="border-bottom: 1px #111111 solid;"><b>Performance Targets</b></td><td style="border-bottom: 1px #111111 solid;"><? echo $performance_targets; ?>&nbsp;</td></tr>
<tr><td style="border-bottom: 1px #111111 solid;"><b>Summary of Data Collected <br />(Performance Results)</b></td><td style="border-bottom: 1px #111111 solid;"><? echo $data_summary; ?>&nbsp;</td></tr>
<tr><td style="border-bottom: 1px #111111 solid;"><b>Recommended Actions</b></td><td style="border-bottom: 1px #111111 solid;"><? echo $recommended_actions; ?>&nbsp;</td></tr>
