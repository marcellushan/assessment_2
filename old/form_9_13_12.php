...
$headeradd .= "<a href=\"form.php?team=" . $unitteamid . "\">" . $unitteamname . "</a>&nbsp;&nbsp;-&nbsp;&nbsp;";
}
...
<td valign="top">
<b style="font-size: 20px;">Assessment Report Form</b><? if (@$_GET['admin'] == "1") { ?>&nbsp;&nbsp;<a href="report.php">Back to Report</a>&nbsp;&nbsp;<a href="print_form.php?admin=1&id=<? echo @$assessment_id; ?>" target="_new"><img src="printer.png" border="0"></a><? } ?>
...
<tr><td><input type="submit" value="<? if ((@$_GET['admin'] == "1") || ($assessment_check >= "1")) { echo "Update Form"; } else { echo "Submit Form"; } ?>" <? if (($assessment_check < "1") && (@$_GET['admin'] != "1") && (@$assessment_lock != "1")) { echo "DISABLED"; }?> /></td><td></td></tr>
